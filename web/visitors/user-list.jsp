...
<%-- 
    Document   : user-list
    Created on : Apr 9, 2025, 4:52:50 PM
                        ...
                        <tbody>
                            ...
                            <c:forEach var="user" items="${listUser}">
                                <tr>
                                    ...
                                    <td><a href="<%=request.getContextPath()%>/users/edit?id=<c:out value='${user.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="<%=request.getContextPath()%>/users/delete?id=<c:out value='${user.id}' />">Delete</a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
